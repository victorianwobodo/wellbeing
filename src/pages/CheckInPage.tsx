...
import { Check, ExternalLink, Zap, Plus, Trash2 } from 'lucide-react';
...
export function CheckInPage() {
  ...
  const [newAudit, setNewAudit] = useState({ activity: '', type: 'Restored' as const, action: 'Keep' as const });
      ...
      <section className="space-y-4">
        ...
        <div className="bg-white border-[0.5px] border-border p-5 rounded-2xl flex items-center justify-between">
          ...
          <Button variant="ghost" size="sm" className="text-xs font-semibold text-primary/70 h-8" asChild>
            <a href="limber://" onClick={(e) => {
              window.setTimeout(() => { window.location.href = "https://www.limberhealth.com" }, 1500);
            }}>
